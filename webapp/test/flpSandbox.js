		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#appcurdoperations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appcurdoperations-display": {
								"semanticObject": "appcurdoperations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.curdoperations",
									"url": sap.ui.require.toUrl("app/curdoperations")
								}
							}
						}
					}
